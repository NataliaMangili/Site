    ...
    <br>
        ...
        <%
            ...
            <%  } %>
             ...
             <form action="servCurriculosGeneric" method="POST">
            ...
            <div class="form-group">
                ...
                <Br />
                    ...
                    <input class="form-control form-control-sm" type="tel" name="tel" placeholder="Telefone" style="margin-top: 8px;width: 300px;" required="">
