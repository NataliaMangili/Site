...
<%
       ...
       formestagio = (FormEstagio) sessao.getAttribute("FORMESTAGIO");
        ...
        <div class="row justify-content-center">
            <div class="counter-container col-md-12 col-lg-10">
                ...
                <div class="mbr-text mbr-fonts-style display-7">
                    <ul>
                        <li><strong>Nome Completo:&nbsp;</strong><%=formestagio.getNomeCompleto() %></li>
                        <li><strong>Email:&nbsp;</strong><%=formestagio.getEmail() %></li>
                        <li><strong>Telefone:&nbsp;</strong><%=formestagio.getTelefone() %></li>
                        <li><strong>Curso Atual:&nbsp;</strong><%=formestagio.getCursoAtual() %></li>
