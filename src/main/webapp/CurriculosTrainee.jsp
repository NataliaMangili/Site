...
<%@page import="Controle.Banco.FormTrainee"%>
<%@page import="Controle.Banco.FormEstagio"%>
...
<%
       ...
       formtrainee = (FormTrainee) sessao.getAttribute("FORMTRAINEE");
   %>
        ...
        <div class="row justify-content-center">
            <div class="counter-container col-md-12 col-lg-10">
                ...
                <div class="mbr-text mbr-fonts-style display-7">
                    <ul>
                        <li><strong>Nome Completo:&nbsp;</strong><%=formtrainee.getTxtNome() %></li>
                        <li><strong>Email:&nbsp;</strong><%=formtrainee.getTxtEmail() %></li>
                        <li><strong>Telefone:&nbsp;</strong><%=formtrainee.getTxtTelefone() %></li>
                        <li><strong>Curso Atual:&nbsp;</strong><%=formtrainee.getTxtCurso() %></li>
            ...
            <div class="counter-container col-md-12 col-lg-10">
                ...
                <div class="mbr-text mbr-fonts-style display-7">
                    <ul>
                        ...
                        <li><strong>Curso Atual:&nbsp;</strong></li>
                        <li><strong>PDF do Curriculo:&nbsp;</strong>Baixar</li>
                    </ul>
                </div>
            </div>
