...
<%@page import="Controle.Banco.CadVaga"%>
...
<%
       ...
       cadvaga = (CadVaga) sessao.getAttribute("CADVAGA");
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu1 cid-sK3aBAB1Gq" once="menu" id="menu1-1d">
    ...
    <br>
    <br>
<section data-bs-version="5.1" class="clients2 cid-sOIdVrfpDn" id="clients2-1f">
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card-box align-center">
                        ...
                        <h5 class="card-title mbr-fonts-style mb-3 display-5">
                            <strong><%=cadvaga.getTitulo() %></strong>
                        </h5>
                        <p class="mbr-text mbr-fonts-style mb-4 display-4">
                            <%=cadvaga.getDescricao() %></p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-primary-outline display-4" href="FormGenerico.jsp">Aplicar-se</a></div>
                    </div>
                </div>
            </div>
            <div class="card col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="img-wrapper">
                        <img src="assets/images/mbr-280x187.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box align-center">
                        
                        <h5 class="card-title mbr-fonts-style mb-3 display-5">
                            <strong>Ainda não postada</strong>
                        </h5>
                        <p class="mbr-text mbr-fonts-style mb-4 display-4">
                            Sem descrição.</p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-primary-outline display-4" href="Home.html">Aplicar-se</a></div>
                    </div>
                </div>
            </div>
            <div class="card col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="img-wrapper">
                        <img src="assets/images/mbr-280x190.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box align-center">
    ...
    <br>
    <br>
<section data-bs-version="5.1" class="footer3 cid-sKHX89bvj6" once="footers" id="footer3-1e">
...
</section><section style="background-color: #fff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif; color:#aaa; font-size:12px; padding: 0; align-items: center; display: flex;"><a href="https://mobirise.site/j" style="flex: 1 1; height: 3rem; padding-left: 1rem;"></a><p style="flex: 0 0 auto; margin:0; padding-right:1rem;">How to design a website - <a href="https://mobirise.site/x" style="color:#aaa;">Learn more</a></p></section><script src="assets/bootstrap/js/bootstrap.bundle.min.js"></script>  <script src="assets/smoothscroll/smooth-scroll.js"></script>  <script src="assets/ytplayer/index.js"></script>  <script src="assets/dropdown/js/navbar-dropdown.js"></script>  <script src="assets/theme/js/script.js"></script>  
