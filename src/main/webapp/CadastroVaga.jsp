<%-- 
    Document   : CadastroVaga
    Created on : 1 de nov. de 2021, 20:36:33
    Author     : User
--%>
...
<body>
    ...
    <section data-bs-version="5.1" class="content4 cid-sKHUScLrHc" id="content4-11">
            ...
            <div class="row justify-content-center">
                <div class="title col-md-12 col-lg-10">
                    <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2">
                        <strong>Cadastre aqui a vaga disponível de seu negócio:</strong>
                    </h3>
                </div>
            </div>
        </div>
  ...
  <form action="servCadVagas" method="POST">
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Descrição da Vaga</label>
            <textarea class="form-control" name="descricao" id="descricao" rows="3"></textarea>
        </div>
        <br />
        <div class="btn-group" role="group" aria-label="Basic example">
            <button type="submit" value="Enviar" class="btn btn-primary">Cadastrar</button> <br/>
            </div>
            <br />
            <br />
            <br />
            ...
            <h4>Veja aqui os curriculos de Estágio recebidos:</h4>   
            <div class="mbr-section-btn"><a class="btn btn-primary display-4" href="CurriculosEstagios.jsp">Ver</a></div> 
 
            <br />
            <h4>Veja aqui os curriculos de Trainee recebidos:</h4>
            <div class="mbr-section-btn"><a class="btn btn-primary display-4" href="CurriculosTrainee.jsp">Ver</a></div>
 

            <br />
            <h4>Veja aqui os outros curriculos recebidos:</h4> 
            <div class="mbr-section-btn"><a class="btn btn-primary display-4" href="CurriculosGenericos.jsp">Ver</a></div>  
        ...
        <div class="container">
            <div class="mbr-section-head">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-5"><strong>Outra dúvida? Contate-nos!</strong></h3>
                <h4 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-7">Nossos meios de comunicação:</h4>
            </div>
                    ...
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            ...
                            <p class="mbr-text mbr-fonts-style mb-2 display-4">
                                Responderemos o mais rápido possível!<br>Segunda - Sábado
                            </p>
                            <h5 class="link mbr-fonts-style display-4">Enviar e-mail</h5>
                        </div>
                    </div>
                </div>
                <div class="card col-12 col-lg-6">
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            ...
                            <p class="mbr-text mbr-fonts-style mb-2 display-4">Segunda - Sexta 09:00 - 18:00</p>
                            <h5 class="link mbr-black mbr-fonts-style display-7">
                                Número:<a href="tel:+12345678910" class="text-primary">&nbsp;(014) 123 45 67</a>
                            </h5>
                        </div>
                    </div>
                </div>
