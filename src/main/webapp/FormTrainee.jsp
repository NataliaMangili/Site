    ...
    <br>
        ...
        <%
            ...
            <%  } %>
             ...
             <form action="serCurriculos" method="POST">
                 
            <div class="form-group">
                    <h5>Informações Necessárias:</h5>
                     <Br />
                     <input class="form-control form-control-sm" type="text" name="txtNome" placeholder="Nome Completo" style="margin-top: 8px;width: 600px;" required="">
                    <input class="form-control form-control-sm" type="email" name="txtEmail" placeholder="Email" required="" style="margin-top: 8px;width: 600px;">                   
                    ...
                    <input class="form-control form-control-sm" type="text" name="txtCurso" placeholder="Curso Atual" style="margin-top: 8px;width: 400px;" required="">
